				...
				<div class="row">
					<div class="col-2 col-12-medium">
						<div class="sidebar">
							<!-- Sidebar -->
							<section>
								<h3><span><a href="solo.php">SOLO</a></span></h3>
								<h3 class="current"><span><a href="ensemble.php">ENSEMBLE</a></span></h3>
							</section>
						</div>
					</div>
									...
									<?php
										...
										while($row = mysqli_fetch_array($result_ensemble)){
                                            if($row['composer']){
                                                ...
                                                echo "<div class='row repertoires' style='margin-top: 15px;'>";
                                            }
