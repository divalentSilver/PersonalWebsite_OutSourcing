...
<head>
	<title>Jeonghyeon Joo | Writings</title>
	<meta charset="utf-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
    <meta name="robots" content="index,follow">
    <meta name="description" content="Jeonghyeon Joo | Writings">
    <meta property="og:url" content="http://jeonghyeonjoo.com/writings.php">
    <meta property="og:title" content="Jeonghyeon Joo">
    <meta property="og:type" content="website">
    <meta property="og:image" content="images/metaimg.png">
    <meta property="og:description" content="Jeonghyeon Joo | Writings">
	...
	<div id="page-wrapper">
		...
		<nav id="nav">
			...
			<ul class="container" style="padding-left: 0px;">
				...
				<li class="current"><a href="writings.php">WRITINGS</a></li>
				<li>
